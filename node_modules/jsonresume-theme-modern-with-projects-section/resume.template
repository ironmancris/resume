  ...
  <div class="row">
    <div class="col-md-8 col-md-offset-2">
      ...
      <section class="row">
        ...
        <p>{{basics.summary}}</p>
        {{#basics.phone}}
        <strong>Phone:</strong> {{bio.phone}} <br />
        {{/basics.phone}}
        {{#basics.email}}
        <strong>Email:</strong> {{basics.email}}<br />
        {{/basics.email}}
        {{#profiles.github}}
        <strong>Github:</strong> <a href="https://github.com/{{bio.profiles.github}}">{{profiles.github}}</a><br />
        {{/profiles.github}}
        {{#profiles.twitter}}
        <strong>Twitter:</strong> <a href="https://twitter.com/{{bio.profiles.twitter}}">@{{profiles.twitter}}</a><br />
        {{/profiles.twitter}}
        </div>
      </section>
      {{#work.length}}
